(function () {
    ...
    angular
        .module('jinibulk')
        .factory('jinibulkService', ['$http', '$q', '__jiniEnv', function ($http, $q, __jiniEnv) {
            var service = {};

            service.getForretningsOmrade = function () {
                var deferred = $.Deferred();
                $http.get(__jiniEnv.jiniApiUrl + 'v1/Jini/GetDepartmentsAndEditorial').success(function (data) {
