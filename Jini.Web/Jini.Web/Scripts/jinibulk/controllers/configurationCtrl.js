...
(function () {
    ...
    angular
        .module('jinibulk')
        .controller('configurationCtrl', ['$scope', 'jinibulkService', '__jiniEnv', '$q',
            function ($scope, jinibulkService, __jiniEnv, $q) {
                ...
                $scope.PriceChanged = function (e) {
                    ...
                    jinibulkService.PriceChanged(angular.copy($scope.OrignalDataSource), parseInt(addPrice), selectedRowIds, rows)
                    if (addPrice > 0) {
                ...
                $scope.PriceChangedIncTax = function (e) {
                    ...
                    jinibulkService.PriceChangedIncTax(angular.copy($scope.OrignalDataSource), parseInt(percentage), selectedRowIds, rows)
                    if (percentage > 0) {
                ...
                $scope.Save = function (salesConfigurations) {
                    ...
                    for (var m = 0; m < salesConfigurations.length; m++) {
                        ...
                        promiseArray.push(jinibulkService.saveSalesConfiguration(salesConfigurations[m]), $scope);
                ...
                $scope.mainGridOptions = {
                    ...
                    dataSource: {
                        transport: {
                            read: {
                                url: __jiniEnv.jiniApiUrl + "v1/JiniBulk/GetDeflatedSalesConfigurations",
                                type: "POST",
